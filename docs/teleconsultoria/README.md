# Teleconsultoria - Modelo Inicial
...
- checklist-lgpd.md – checklist de LGPD e segurança
- operacao.md – playbook operacional (onboarding, suporte, incidentes)
- backlog.md – backlog por fases e marcos
- postman-colecao-exemplo.json – coleção de exemplo com variáveis de ambiente

Como usar:

1. Leia `arquitetura.md` e escolha o cenário mínimo viável (MVP) ou o cenário estendido.
2. Adapte `fluxos.md` para a sua realidade (especialidades, agenda, triagem).
3. Valide `checklist-lgpd.md` com a TI/Jurídico do hospital.
